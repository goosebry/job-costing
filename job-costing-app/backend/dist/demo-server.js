...
app.get('/api/change-orders', (_req, res) => {
    res.json(demoChangeOrders);
});
app.get('/api/change-orders/pending', (_req, res) => {
...
// Reports routes
app.get('/api/reports/profit-loss', (_req, res) => {
    res.json({
        summary: {
            totalRevenue: 125000,
            totalCosts: 78000,
...
app.get('/api/reports/labor-analysis', (_req, res) => {
    res.json({
        summary: {
            totalHours: 156,
            totalCost: 7800,
